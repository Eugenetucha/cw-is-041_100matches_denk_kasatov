...
def early_dysplay():
    ...
    textsurface6 = myfont.render(str(crnt_player1), False, (0, 0, 0))
    screen.blit(textsurface6, (150, 260))
    textsurface7 = myfont.render(str(crnt_player2), False, (0, 0, 0))
    screen.blit(textsurface7, (280, 260))
    pygame.display.flip()
    pressed()
    runGame = True
    while runGame:
